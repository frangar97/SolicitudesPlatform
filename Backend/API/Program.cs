...
builder.Services.AddTransient<IUsuarioZonaService, UsuarioZonaService>();
builder.Services.AddTransient<IUsuarioTipoSolicitudService, UsuarioTipoSolicitudService>();
